    ...
    public static class TileColorUtility
    {
        ...
        static TileColorUtility()
        {
           ...
           s_mixTable.Add(new MixInput(TileColor.White, TileColor.Blue), TileColor.Blue);
            ...
            s_mixTable.Add(new MixInput(TileColor.Red, TileColor.White), TileColor.White);
            ...
            s_mixTable.Add(new MixInput(TileColor.Green, TileColor.White), TileColor.White);
            ...
            s_mixTable.Add(new MixInput(TileColor.Blue, TileColor.White), TileColor.White);
            ...
            s_mixTable.Add(new MixInput(TileColor.Yellow, TileColor.White), TileColor.White);
            ...
            s_mixTable.Add(new MixInput(TileColor.Magenta, TileColor.White), TileColor.White);
            ...
            s_mixTable.Add(new MixInput(TileColor.Cyan, TileColor.White), TileColor.White);
